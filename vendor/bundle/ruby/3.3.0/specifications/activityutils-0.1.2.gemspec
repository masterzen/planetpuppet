# -*- encoding: utf-8 -*-
# stub: activityutils 0.1.2 ruby lib

Gem::Specification.new do |s|
  s.name = "activityutils".freeze
  ...
  s.date = "2020-02-01"
  s.description = "activityutils - activity (timeline) utilities".freeze
  ...
  s.homepage = "https://github.com/rubycoco/activityutils".freeze
  s.licenses = ["Public Domain".freeze]
  s.rdoc_options = ["--main".freeze, "README.md".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 2.2.2".freeze)
  s.rubygems_version = "2.5.2".freeze
  s.summary = "activityutils - activity (timeline) utilities".freeze
